...
addon_info = {
	...
	"addon_name": "NVDAControlEx",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("NVDAControlEx"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Provides an extended interface to control NVDA from external applications"""),
	# version
	"addon_version": "0.1",
	# Author(s)
	"addon_author": "M_maker <georgijbondarenko248@gmail.com>",
...
pythonSources = ["addon/globalPlugins/NVDAControlEx/__init__.py"]
